# The FAANG Problem-Solving Framework - How to Ace Every Interview
...
- Eight-step interview process with exact words to say
- Pattern recognition guide by data type and wording
- Optimization toolkit for O(n^2), memory-heavy, and recursive solutions
- Interviewer evaluation: communication, ambiguity, code quality, testing, hints
- Company tendencies and eight-week preparation schedule

## Deep Teaching Notes

### 1. Eight-step interview process with exact words to say

**Beginner explanation:** This is one of the core ideas for The FAANG Problem-Solving Framework - How to Ace Every Interview. Start by saying it in plain language before reaching for code. A beginner should understand what problem this idea solves, what input it expects, and what output it creates.
...
### 2. Pattern recognition guide by data type and wording
...
### 3. Optimization toolkit for O(n^2), memory-heavy, and recursive solutions
...
### 4. Interviewer evaluation: communication, ambiguity, code quality, testing, hints
...
### 5. Company tendencies and eight-week preparation schedule
...
- `DSA JS/src/roadmap/faang-roadmap.md`
- `DSA JS/src/roadmap/high-priority-topics.md`

### Imported Notes: `DSA JS/src/roadmap/faang-roadmap.md`
...
### Imported Notes: `DSA JS/src/roadmap/high-priority-topics.md`

General Topic By Sir Osama
...
**Brute force baseline:** Always describe the direct solution first. For clarifying questions, the brute force version usually repeats work: scanning the same area again, recalculating a value already known, trying every pair, or exploring branches that can be proven impossible. The baseline matters because it gives you a correctness anchor and gives the interviewer a clear before-and-after optimization story.
...
**Previous:** [Divide and Conquer](../Phase-5-Advanced-Algorithms/07-Divide-and-Conquer.md) | **Next:** [Array and String - 30 FAANG Questions with Complete Solutions](../Phase-6-FAANG-Interview-Preparation/02-Array-and-String-Questions.md)
