# Searching Algorithms - From Linear to Logarithmic
...
- Linear search and binary search templates
- First occurrence, last occurrence, upper bound, rotated arrays, 2D matrix search
- Binary search on answer with Koko and bouquet-style constraints
- Ternary, exponential, and interpolation search concepts

## Deep Teaching Notes

### 1. Linear search and binary search templates

**Beginner explanation:** This is one of the core ideas for Searching Algorithms - From Linear to Logarithmic. Start by saying it in plain language before reaching for code. A beginner should understand what problem this idea solves, what input it expects, and what output it creates.
...
### 2. First occurrence, last occurrence, upper bound, rotated arrays, 2D matrix search
...
### 3. Binary search on answer with Koko and bouquet-style constraints
...
### 4. Ternary, exponential, and interpolation search concepts
...
- `DSA JS/src/algorithms/binary-search/notes.md`
- `DSA JS/src/algorithms/binary-search/implementation.js`
- `DSA JS/src/problems/leetcode/easy/search-insert-position-notes.md`
- `DSA JS/src/problems/leetcode/medium/search-in-rotated-sorted-array-notes.md`
- `DSA JS/src/problems/leetcode/medium/search-in-rotated-sorted-array.js`

### Imported Notes: `DSA JS/src/algorithms/binary-search/notes.md`
...
### Imported Implementation: `DSA JS/src/algorithms/binary-search/implementation.js`
...
### Imported Notes: `DSA JS/src/problems/leetcode/easy/search-insert-position-notes.md`
...
### Imported Notes: `DSA JS/src/problems/leetcode/medium/search-in-rotated-sorted-array-notes.md`
...
### Imported Implementation: `DSA JS/src/problems/leetcode/medium/search-in-rotated-sorted-array.js`
...
**Brute force baseline:** Always describe the direct solution first. For linear search, the brute force version usually repeats work: scanning the same area again, recalculating a value already known, trying every pair, or exploring branches that can be proven impossible. The baseline matters because it gives you a correctness anchor and gives the interviewer a clear before-and-after optimization story.
...
**Previous:** [Sorting Algorithms - Complete Mastery](../Phase-4-Core-Algorithms/01-Sorting-Algorithms-Complete.md) | **Next:** [Two Pointers Technique - The O(n^2) to O(n) Converter](../Phase-4-Core-Algorithms/03-Two-Pointers-Technique.md)
