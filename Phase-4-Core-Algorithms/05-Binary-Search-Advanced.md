...
- Monotonic predicates and binary search on answer
- Define lo, hi, and isValid
- Ship packages, split array, Koko, magnetic force, gas station distance
- Matrix search as flattened binary search or staircase search

## Deep Teaching Notes

### 1. Monotonic predicates and binary search on answer

**Beginner explanation:** This is one of the core ideas for Binary Search - Advanced Patterns. Start by saying it in plain language before reaching for code. A beginner should understand what problem this idea solves, what input it expects, and what output it creates.
...
### 3. Ship packages, split array, Koko, magnetic force, gas station distance
...
### 4. Matrix search as flattened binary search or staircase search
...
- `DSA JS/src/problems/leetcode/medium/koko-eating-bananas-notes.md`

### Imported Notes: `DSA JS/src/problems/leetcode/medium/koko-eating-bananas-notes.md`
...
**Brute force baseline:** Always describe the direct solution first. For monotonic predicate, the brute force version usually repeats work: scanning the same area again, recalculating a value already known, trying every pair, or exploring branches that can be proven impossible. The baseline matters because it gives you a correctness anchor and gives the interviewer a clear before-and-after optimization story.
...
**Previous:** [Sliding Window Technique - The Subarray Master](../Phase-4-Core-Algorithms/04-Sliding-Window-Technique.md) | **Next:** [Recursion and Backtracking - The Decision Tree Master](../Phase-4-Core-Algorithms/06-Recursion-and-Backtracking.md)
